...
const App = () => {
  ...
  const donate = async (publicKey) => {
    try{
      ...
      console.log("Doanted some sol to: ", publicKey.toString());
      getCampaigns();
    }catch(error)
    {
  ...
  const withdraw = async (publicKey) =>{
    try{
      ...
      console.log("withdrew some sol from: ", publicKey.toString())
    }catch(error){
  ...
  const renderConnectedContainer = () => (
    <>
      ...
      <button onClick={getCampaigns}>get a ist of Campaigns...</button>
